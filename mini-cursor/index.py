...
Flow:
  1. Receive user instruction via API Gateway
  2. Call Amazon Bedrock (Claude 3.5 Sonnet) to generate code
  3. Create GitHub branch → commit file → open Pull Request
